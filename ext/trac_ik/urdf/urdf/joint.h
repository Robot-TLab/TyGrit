...
struct JointDynamics {
  ...
  JointDynamics(const JointDynamics& jd)
      : damping(jd.damping), friction(jd.friction) {}
...
struct JointCalibration {
  ...
  JointCalibration(const JointCalibration& jc)
      : rising(jc.rising), falling(jc.falling) {}
